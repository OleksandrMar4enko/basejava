...
public class DataStreamSerializer implements StreamSerializer {
	...
	private interface ElementConsumer<T> {
	...
	private <T> void writeCollection(DataOutputStream dos, Collection<T> collection, ElementConsumer<T> consumer) throws IOException {
